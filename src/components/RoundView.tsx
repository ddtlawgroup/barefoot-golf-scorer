    ...
    <div className="px-4 py-4 space-y-4">
      ...
      <div className="text-center">
        ...
        <p className="text-cream-dim text-sm">
          Round {round + 1} &middot; Par {ROUNDS[round].par}
          {isTeamRound ? ' &middot; Best Ball' : ' &middot; Individual Skins'}
        </p>
      </div>
      ...
      {nassau && teams && (
        <div className="bg-green-card rounded-xl border border-gold/20 p-3">
          <h3 className="text-xs text-gold font-medium mb-2 uppercase tracking-wider">Nassau</h3>
      ...
      {skins && (
        <div className="bg-green-card rounded-xl border border-gold/20 p-3">
          <h3 className="text-xs text-gold font-medium mb-2 uppercase tracking-wider">Skins</h3>
      ...
      {/* Stableford for this round */}
      <div className="bg-green-card rounded-xl border border-gold/20 p-3">
        <h3 className="text-xs text-gold font-medium mb-2 uppercase tracking-wider">Stableford Points</h3>
        <div className="grid grid-cols-4 gap-2 text-center">
          {PLAYERS.map((name, p) => (
            <div key={p} className="bg-green-deeper/50 rounded-lg py-2">
              <div className="text-cream-dim text-xs mb-1">{name}</div>
