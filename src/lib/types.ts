...
export const DEFAULT_PARS: number[][] = [
  // Fazio (par 71): typical par-71 layout
  [4, 5, 3, 4, 4, 4, 3, 4, 4, 4, 4, 3, 4, 5, 4, 3, 4, 4],
  // Love (par 72)
  [4, 4, 5, 3, 4, 4, 3, 5, 4, 4, 3, 5, 4, 4, 3, 4, 4, 5],
  // Norman (par 72)
  [4, 5, 4, 3, 4, 3, 4, 5, 4, 4, 4, 3, 5, 4, 4, 3, 4, 5],
  // Dye (par 72)
  [4, 3, 5, 4, 4, 4, 3, 4, 5, 4, 5, 3, 4, 4, 4, 3, 5, 4],
];
